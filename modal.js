...
if (window.addEventListener) {
  window.addEventListener('load', createModal, false);
} else {
...
function createModal() {
  ...
  const popupLinks = document.querySelectorAll('.js-popup-link'); // добавить на ссылку,чтобы открыть попап
  ...
  createModal.popupOpen = popupOpen
